...
function productToFormData(product: Product): ProductFormData {
  return {
    ...
    hair_type: product.specifications?.hair_type || "straight",
    lace_type: product.specifications?.lace_type || "lace_front",
    density: product.specifications?.density || "150%",
    length: product.specifications?.length || "14",
    color: product.specifications?.color || "Natural Black",
